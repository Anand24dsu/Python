...
def insert_job_details(job_name, job_details):
...
result = get_job_details_from_url(jenkins_url="http://localhost:8080", job_name=job_name)

if result is not None:
    print_job_details(result)
    insert_job_details(job_name, result)